                      ...
                      content: Column(
                        ...
                        children: [
                          CustomFilledBtn(
                            height: 40.0,
                            onPressed: () => launchURL(
                                "https://api.whatsapp.com/send?phone=923436775290&text=Looking%20for%20a%20flutter%20developer"),
                          ...
                          CustomFilledBtn(
                            height: 40.0,
                            onPressed: () => launchURL(
                                "https://www.fiverr.com/roy_waqas"),
                            btnColor: kPrimaryColor,
                            child: Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                ...
                                //   color: kTextColor,
                                // ),
                                Image.asset('assets/fiverr.png',color: Colors.white,scale: 10,),
                                const SizedBox(width: 8.0),
                                Text(
                                  "Fiverr",
                                  style: TextStyle(color: kTextColor),
